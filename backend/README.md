...
## Project Structure
    ...
    ├── falling_darkness_de_79652  # Django project configurations
...
1. Clone this repo and `cd falling_darkness_de_79652`
...
2. Clone this repo and `cd falling_darkness_de_79652`
